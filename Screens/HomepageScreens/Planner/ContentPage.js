...
const ContentPage = () => {
    ...
    const semButton = (sem) => {
        return (
            <TouchableOpacity style={{...styles.touchStyle, marginVertical: 20}} activeOpacity = {0.9}>
    ...
    const sideColor = () => {
        return (
            <View style={{flexDirection: 'row'}}>
                <View style={{width: 60, height: 0.085 * height, borderRadius: 20, backgroundColor: '#FF6161',
                    elevation: 1,
                    shadowColor: "#000",
                    shadowOffset: {
                        width: 0,
                ...
                <View style={{width: 40, height: 0.085 * height, backgroundColor: '#FF6161', right: 40,elevation: 1,}}/>
            </View>
        )
    }
